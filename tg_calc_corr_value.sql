...
The given mathematical function is used to generate a SELECT statement which is executed and the resulting value is written to the value_corrected field.
